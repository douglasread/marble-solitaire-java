...
/**
 * Class to test getScore() and isGameOver() for the European Marble Solitaire Model.
 */
public class EuropeanModelTestGetScoreAndIsGameOver {

  public EuropeanModelTestGetScoreAndIsGameOver() {
  ...
  public void initializeExamples() {
    ...
    differentEmptyAndThickness = new EuropeanSolitaireModelImpl(5, 12, 5);
  }

  @Test
  public void testGetScore() {
    assertEquals(36, normalGame.getScore());
    assertEquals(128, differentEmptyAndThickness.getScore());
    normalGame.move(3, 1, 3, 3); // decrease by 1
    differentEmptyAndThickness.move(10, 5, 12, 5); // decrease by 1
    assertEquals(35, normalGame.getScore());
    assertEquals(127, differentEmptyAndThickness.getScore());
  }
  ...
  public void testGetScoreGameEnd() {
    ...
    assertFalse(normalGame.isGameOver());
    assertEquals(34, normalGame.getScore());
    normalGame.move(4, 6, 4, 4);
    assertFalse(normalGame.isGameOver());
    assertEquals(33, normalGame.getScore());
