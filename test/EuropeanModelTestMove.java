...
/**
 * Tests for the {@code move(int, int, int, int)} method for the EuropeanModel.
 */
public class EuropeanModelTestMove {

  public EuropeanModelTestMove() {
  ...
  public void testBasicMoves() {
    ...
    normalGame.move(5, 1, 3, 1); // down to up
    assertEquals(
        "    O O O\n"
            + "  O O O O O\n"
            + "O O O O O O O\n"
